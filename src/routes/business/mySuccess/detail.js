...
const propTypes = {
  mySuccessDetail: PropTypes.object,
  loading: PropTypes.object,
}
const namespace = 'mySuccessDetail'
const MySuccessDetail = ({ mySuccessDetail, loading }) => {
  const {
    showReplyList,
    detail,
    sessionList,
...
MySuccessDetail.propTypes = propTypes
export default connect(({ mySuccessDetail, loading }) => ({
  mySuccessDetail,
  loading,
}))(MySuccessDetail)
