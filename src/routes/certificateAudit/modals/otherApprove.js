  ...
  const formData = (data, type, isOlder) => {
    ...
    return [
      detailData.oldFlag && <div>{isOlder ? '原证信息' : '新证信息'}</div>,
      {
        ...
        view: true,
        viewRender(value) {
          const certificateType = ['服务承诺书', '廉政协议书']
          return certificateType[value - 6]
        },
        options: {
...
export default Form.create()(OtherApprove)
