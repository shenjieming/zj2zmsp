...
const propTypes = {
  bankCreditAudit: PropTypes.object,
  loading: PropTypes.object,
}
const BankCreditAudit = ({ bankCreditAudit, loading }) => {
  const { dispatchAction, getLoading } = getBasicFn({ namespace, loading })
  const { data, searchParam, pagination } = bankCreditAudit
  // dispachAction
...
BankCreditAudit.propTypes = propTypes
export default connect(({ bankCreditAudit, loading }) => ({ bankCreditAudit, loading }))(
  BankCreditAudit,
)
