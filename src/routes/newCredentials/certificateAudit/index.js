...
const propTypes = {
  newCertificateAudit: PropTypes.object,
  loading: PropTypes.object,
}
const namespace = 'newCertificateAudit'
const CertificatePush = ({ newCertificateAudit, loading }) => {
  const {
    tabType,
    reviewSearchData,
    refusedSearchData,
...
export default connect(({ newCertificateAudit, loading }) => ({ newCertificateAudit, loading }))(
  CertificatePush,
)
