...
const CompareModal = ({ versionDoubleList, compareModalVisible, dispatchAction, getLoading }) => {
  ...
  const [
    { materialsSkuVersionCode, lastEditName, lastEditTime },
    {
      materialsSkuVersionCode: materialsSkuVersionCode2,
  ...
  const tableParam = {
    columns: [
      ...
      },
      {
        title: (
          <div>
            <p>版本号：{materialsSkuVersionCode}</p>
      ...
      },
      {
        title: (
          <div>
            <p>版本号：{materialsSkuVersionCode2}</p>
