...
const propTypes = {
  myReplyDetail: PropTypes.object,
  loading: PropTypes.object,
}
const namespace = 'myReplyDetail'
const MyReplyDetail = ({ myReplyDetail, loading }) => {
  const {
    showReplyList,
    detail,
    sessionList,
  ...
  const contactBtn = chanceContactOpenFlag && (
    <span>
      {showNumber ? (
        <Button type="primary">
...
MyReplyDetail.propTypes = propTypes
export default connect(({ myReplyDetail, loading }) => ({
  myReplyDetail,
  loading,
}))(MyReplyDetail)
